      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="inline-flex items-center px-4 py-1.5 mb-6 bg-white/10 border border-white/20 rounded-full">
            ...
            <span className="text-white/90 text-sm font-semibold tracking-wide">READY TO GET STARTED</span>
          </div>
          ...
          >
            Grow faster with Logical CRM
          </h2>
          <p className="text-white/80 text-lg md:text-xl max-w-2xl mx-auto">
            Schedule jobs, dispatch teams, send invoices, and get paid — all from one modern, easy‑to‑use platform.
          </p>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-white/70 text-sm">
            <div className="inline-flex items-center gap-2"><CheckIcon /> No credit card required</div>
            <div className="inline-flex items-center gap-2"><CheckIcon /> 14‑day free trial</div>
            <div className="inline-flex items-center gap-2"><CheckIcon /> Cancel anytime</div>
            <div className="inline-flex items-center gap-2"><CheckIcon /> 24/7 support</div>
          </div>
        </div>
      </div>
    </section>
...
function CheckIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 20 20" fill="currentColor" className="text-emerald-300">
